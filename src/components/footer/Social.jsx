    ...
    <div className={styles.social}>
        <div className={styles.socialIcons}>
            ...
            <div className={styles.socialIconsContainer}>
              <div className={styles.iconbox}><a href="https://facebook.com" target="_blank" rel="noopener norefferer"><GrFacebook className={styles.icons}/></a></div>
              ...
              <div className={styles.iconbox}><a href="https://linkedin.com" target="_blank" rel="noopener norefferer"><GrLinkedin className={styles.icons}/></a></div>
            </div>
        </div>
    </div>
  )
